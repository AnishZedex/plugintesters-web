  ...
  return (
    <>
      <div className="flex">
        ...
        <div className="w-full grid grid-cols-3 gap-8 mx-auto my-8 md:hidden lg:grid lg:grid-cols-3 lg:gap-4">
          <div className="flex flex-col gap-1 lg:flex-row lg:gap-3">
            ...
            <h1 className="text-center text-sm hover:text-orange-600 font-medium">
              Starting a blog
            </h1>
          </div>
          <div className="flex flex-col gap-1 lg:flex-row lg:gap-3">
